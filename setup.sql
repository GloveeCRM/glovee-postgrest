...
begin
    ...
    -- Return all the form section's questions including settings
    select 
        jsonb_agg(
...
begin
    ...
    _update_form_question_settings_result := forms.update_form_question_settings(_form_question_id, _form_question_settings);
